...
import { CreateVideosTable1777579900000 } from './migrations/1777579900000-CreateVideosTable';
...
describe('Database migrations (integration)', () => {
    ...
    dataSource = createTestDataSource(
      [User, Channel, RefreshToken, VerificationToken, Video],
      {
        ...
        migrations: [
          ...
          CreateVideosTable1777579900000,
        ],
      },
    );
  ...
  afterAll(async () => {
    try {
      ...
      // ignore re-migration errors during teardown
    }
