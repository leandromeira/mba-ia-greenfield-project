...
| **SI-03.2** | Storage Module & MinIO S3 Wrapper | ⏳ Pending | 0/2 | Bucket auto-creation & Presigned URL generation |
| **SI-03.3** | Video Entity, Migration & Module Setup | ⏳ Pending | 0/2 | TypeORM Migration `CreateVideosTable` & `node:crypto` slug helper |
| **SI-03.4** | Video Upload Request & Completion API | ⏳ Pending | 0/2 | `POST /videos/upload-url` & `/complete-upload` |
...
| SI-03.2 | `src/storage/storage.service.spec.ts` | Unit | ⏳ |
| SI-03.2 | `src/storage/storage.service.integration-spec.ts` | Integration | ⏳ |
| SI-03.3 | `src/common/utils/slug.util.spec.ts` | Unit | ⏳ |
| SI-03.3 | `src/videos/entities/video.entity.integration-spec.ts` | Integration | ⏳ |
| SI-03.4 | `src/videos/videos.service.spec.ts` | Unit | ⏳ |
| SI-03.4 | `src/videos/videos.controller.e2e-spec.ts` | E2E | ⏳ |
